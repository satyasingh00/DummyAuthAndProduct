...
public class DummyWebsite {
	...
	public void loginToGetToken() {
		JSONObject js = new JSONObject(); // when we need body json object given = request , content = method/request json body = setewquest when = method perticular method to form
...
//		eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..nTfZ9UUSVlU6vkdVw0D6Fmn_eT8JWEEajdGoTUEerZ8
		...
		.contentType(ContentType.JSON).when().get("https://dummyjson.com/auth/me").then().log().all();
	}
